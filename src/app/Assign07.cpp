...
int main(int argc, char **argv) {
	...
	GLFWwindow* window = setupGLFW("Assign07: chenr", 4, 3, 800, 800, DEBUG_MODE);
	...
	*/
	...
	while (!glfwWindowShouldClose(window)) {
		...
		for (int i = 0; i < meshGLVector.size(); i++) {
			renderScene(meshGLVector, scene->mRootNode, glm::mat4(1.0), modelMatLoc, 0, normMatLoc, viewMat);
		}
